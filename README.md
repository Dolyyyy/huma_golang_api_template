...
- `huma_golang_api_template`: minimal base + `templatectl`
- `huma_golang_api_template_modules`: installable module packs (`auth-token`, `metrics-prometheus`, DB modules, etc.)
